 ...
 * 2020/7/17 14:45
 */
public class CacheInitialException extends RuntimeException {

    /** Constructs a new shared initial exception with {@code null} as its
     * detail message.  The cause is not initialized, and may subsequently be
     * initialized by a call to {@link #initCause}.
     */
    public CacheInitialException() {
        super();
    }
     ...
     */
    public CacheInitialException(String message) {
        super(message);
    }
     ...
     * @since  1.4
     */
    public CacheInitialException(String message, Throwable cause) {
        super(message, cause);
    }
}
